...
// -----------------------------------------------VERIFICAÇÃO DE PERIFÉRICOS I2C---------------------------------------------
void status_check()
{
  ...
  {
    Serial.println (F("Status medusa: ERRO, NÃO ENCONTRADO!"));
  }
  ...
  {
    Serial.println (F("Status RTC:  ERRO, NÃO ENCONTRADO!"));
  }
...
void print_logo()
{
  ...
  Serial.println(logo1);
  Serial.println(logo2);
  Serial.println(logo3);
  Serial.println(logo4);
  Serial.println(logo5);
  Serial.println(logo6);
}
void SD_ERROR(){
  while(true)
  {
